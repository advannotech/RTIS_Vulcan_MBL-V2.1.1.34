...
{
    [Activity(Label = "SettingsPassword")]
    public class SettingsPassword : Activity, View.IOnTouchListener
    {
        Button btnBack;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.C_EnterPassword);

            btnBack = FindViewById<Button>(Resource.Id.btnPBack);
        ...
        private void TxtPassword_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keycode.Enter && e.Event.Action == KeyEventActions.Down)
                {
                    ...
                    {
                        ScanEngineOff();
                        //if (txtPassword.Text == GlobalVar.SettingsPassword)
                        //{
                        ...
                        //{
                            ...
                            {
                                StartActivity(typeof(RTSettings));
                                Finish();
                            }
                            else
                            {
