...
{
    [Activity(Label = "SelectWhseFrom_PPRec")]
    public class SelectWhseFrom : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        ...
        public void layoutStichUp()
        {
            try
            {
                switch (GlobalVar.ProcessName)
                {
                    case "PPtFS":
                        ...
                        lblHeader1.Text = "Receive into Powder Prep";
                        break;
                    case "FStMS":
                        lblHeader1 = FindViewById<TextView>(Resource.Id.lblHeader1);
                        lblHeader1.Text = "Receive into Fresh Slurry";
                        break;
                    case "MStZECT":
                        lblHeader1 = FindViewById<TextView>(Resource.Id.lblHeader1);
                        lblHeader1.Text = "Receive into Mixed Slurry";
                        break;
                    case "ZECT1":
                        lblHeader1 = FindViewById<TextView>(Resource.Id.lblHeader1);
                        lblHeader1.Text = "Receive into Zect 1";
                        break;
                    case "ZECT2":
                        lblHeader1 = FindViewById<TextView>(Resource.Id.lblHeader1);
                        lblHeader1.Text = "Receive into Zect 2";
                        break;
                    case "AW":
                        lblHeader1 = FindViewById<TextView>(Resource.Id.lblHeader1);
                        lblHeader1.Text = "Receive into AW";
                        break;
                    case "Canning":
                        lblHeader1 = FindViewById<TextView>(Resource.Id.lblHeader1);
                        lblHeader1.Text = "Receive into Canning";
                        break;
                    default:
                        break;
                }
                ...
                lblHeader2.Text = "Select Warehouse From";
            ...
            {
                ErrorText = "Exception L001: " + System.Environment.NewLine + ex.ToString();
        ...
        public void GetWHTMSDetails()
        {
            try
            {
                string Whses = Client.GetRecWhseFrom(GlobalVar.ProcessName);
                if (Whses != string.Empty)
                {
                    switch (Whses.Split('*')[0])
                    {
                        case "1":
                            ...
                            break;
                        case "0":
                            ErrorText = "Exception L002: " + System.Environment.NewLine + Whses.Split('*')[1];
                            RunOnUiThread(ShowError);
                            break;
                        case "-1":
                            ErrorText = "Exception L003: " + System.Environment.NewLine + Whses.Split('*')[1];
                            RunOnUiThread(ShowError);
                            break;
                        default:
                            ErrorText = "Exception L004: " + System.Environment.NewLine + "Unexpected error while retreiving data";
                            RunOnUiThread(ShowError);
                            break;
                    }
                }
                ...
                {
                    ErrorText = "Exception L005: " + System.Environment.NewLine + "Unexpected error while retreiving data";
                    RunOnUiThread(ShowError);
                }
            ...
            {
                ErrorText = "Exception L006: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        public void SetWHSpinner()
        {
            ...
            {
                ErrorText = "Exception L007: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        private void SpnWhses_ItemSelected(object sender, AdapterView.ItemSelectedEventArgs e)
        {
            try
            {
                ...
                GlobalVar.RecTransWarehouseFrom = GlobalVar.TransferWarehouses[e.Position].Code;
            }
            catch (Exception ex)
            {
                ErrorText = "Exception L008: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        private void BtnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception L009: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        private void BtnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception L010: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
