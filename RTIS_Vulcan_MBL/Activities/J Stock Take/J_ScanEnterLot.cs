...
{
    [Activity(Label = "J_ScanEnterLot")]
    public class J_ScanEnterLot : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        EditText txtBCD;
        ...
        private void TxtBCD_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                ...
                {
                    GlobalVar.STLot = txtBCD.Text;
                    StartActivity(typeof(J_EnterQty));
                    Finish();
                }
                else
                {
