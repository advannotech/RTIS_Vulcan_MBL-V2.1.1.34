...
using Android.Media;
using RTIS_Vulcan_MBL.Activities.G_Mixed_Slurry.Enter_Recovered;

namespace RTIS_Vulcan_MBL.Activities.G_Mixed_Slurry
{
    [Activity(Label = "G_EnterQty_Rec")]
    public class G_EnterQty_Rec : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        ...
        public void showNext()
        {
            try
            {
                StartActivity(typeof(G_EnterLot_Rec));
                Finish();
            }
            catch (Exception ex)
            {
