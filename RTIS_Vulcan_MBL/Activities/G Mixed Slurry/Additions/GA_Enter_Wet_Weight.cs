...
{
    [Activity(Label = "GA_Enter_Wet_Weight")]
    public class GA_Enter_Wet_Weight : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        ...
        public void layoutStichUp()
        {
            try
            {
                ...
                lblHeader1.Text = "Mixed Slurry Additions";
            ...
            {
                ErrorText = "Exception GA201: " + System.Environment.NewLine + ex.ToString();
        ...
        private void TxtWeight1_KeyPress(object sender, View.KeyEventArgs e)
        {
            ...
            {
                ErrorText = "Exception GA202: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void TxtWeight2_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keycode.Enter && e.Event.Action == KeyEventActions.Down)
                {
                    if (txtWeight2.Text.All(char.IsDigit))
                    {
                        ...
                        Confirm.SetMessage("Tank Code: " + GlobalVar.MSATankCode + System.Environment.NewLine + "Item: " + GlobalVar.MSAItemDesc + System.Environment.NewLine + "Tank Lot: " + GlobalVar.MSALotNum + System.Environment.NewLine + "Current Weight: " + Convert.ToString(GlobalVar.MSACurrentWeight) + System.Environment.NewLine + "Trolley Weight: " + Convert.ToString(qty));
                        Confirm.SetButton("YES", (s, ev) =>
                        {
                            ...
                            Thread t = new Thread(slurryAddition);
                            t.Start();
                        });
            ...
            {
                ErrorText = "Exception GA203: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void BtnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception GA204: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }

        public void slurryAddition()
        {
            try
            {
                string addition = Client.mixedSlurryAddition(GlobalVar.MSATankCode + "|" + GlobalVar.MSAItemCode + "|"+ GlobalVar.MSALotNum + "|" + GlobalVar.MSAFreshTrolley + "|" + qty + "|" + GlobalVar.UserName);
                switch (addition.Split('*')[0])
                {
                    case "1":
                        ...
                        break;
                    case "0":
                        ErrorText = "Exception GA205: " + System.Environment.NewLine + addition.Split('*')[1];
                        RunOnUiThread(ShowError);
                        break;
                    case "-1":
                        ErrorText = "Exception GA206: " + System.Environment.NewLine + addition.Split('*')[1];
                        RunOnUiThread(ShowError);
                        break;
                    default:
                        ErrorText = "Exception GA207: " + System.Environment.NewLine + "Unexpected error while storing data";
                        RunOnUiThread(ShowError);
                        break;
                }
            }
            ...
            {
                ErrorText = "Exception GA208: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void BtnBack_Click(object sender, EventArgs e)
        {
            try
            {
                StartActivity(typeof(GA_Scan_Fresh_Slurry));
                Finish();
            }
            catch (Exception ex)
            {
                ErrorText = "Exception GA210: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
