...
{
    [Activity(Label = "G_EnterQty_ZAC")]
    public class G_EnterQty_ZAC : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        ...
        public void layoutStichUp()
        {
            try
            {
                ...
                lblHeader2.Text = "Enter Chemical Quantity";
        ...
        public void showConfirm()
        {
            try
            {
                ...
                Confirm.SetMessage("Tank: " + GlobalVar.MSTankCode + System.Environment.NewLine + "Item: " + GlobalVar.MSZACDesc + System.Environment.NewLine + "Lot: " + GlobalVar.MSZACLot + System.Environment.NewLine + "Chemical: " + GlobalVar.selectedChemName + System.Environment.NewLine + "Quantity: " + qty);
        ...
        public void setChemical()
        {
            try
            {
                string inserted = Client.updateZACChem(GlobalVar.MSTankType + "|" + GlobalVar.MSTankCode + "|" + GlobalVar.MSItemCode + "|" + GlobalVar.MSZACLot + "|" + GlobalVar.selectedChemName + "|" + qty + "|" + GlobalVar.UserName);
                try
                {
