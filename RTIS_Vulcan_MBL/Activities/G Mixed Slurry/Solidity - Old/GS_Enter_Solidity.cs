...
{
    [Activity(Label = "GS_Enter_Solidity")]
    public class GS_Enter_Solidity : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        ...
        public void layoutStichUp()
        {
            ...
            {
                ErrorText = "Exception GS101: " + System.Environment.NewLine + ex.ToString();
        ...
        private void TxtWeight1_KeyPress(object sender, View.KeyEventArgs e)
        {
            ...
            {
                ErrorText = "Exception GS102: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void TxtWeight2_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keycode.Enter && e.Event.Action == KeyEventActions.Down)
                {
                    if (txtWeight2.Text.All(char.IsDigit))
                    {
                        ...
                        Confirm.SetMessage("Tank Code: " + GlobalVar.MSSTankCode + System.Environment.NewLine + "Item: " + GlobalVar.MSSItemDesc + System.Environment.NewLine + "Lot: " + GlobalVar.MSSLotNum + System.Environment.NewLine + "Tank Weigth: " + GlobalVar.MSSCurrentWeight + System.Environment.NewLine + "Solidity: " + Convert.ToString(qty));
            ...
            {
                ErrorText = "Exception GS103: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void BtnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception GS104: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        public void saveSolidity()
        {
            try
            {
                string saved = Client.setMixedSlurrySolidity(GlobalVar.MSSTankCode + "|" + GlobalVar.MSSItemCode + "|" + GlobalVar.MSSLotNum + "|" + qty + "|" + GlobalVar.UserName);
                switch (saved.Split('*')[0])
                {
                    case "1":
                        ...
                        break;
                    case "0":
                        ErrorText = "Exception GS105: " + System.Environment.NewLine + saved.Split('*')[1];
                        RunOnUiThread(ShowError);
                        break;
                    case "-1":
                        ErrorText = "Exception GS106: " + System.Environment.NewLine + saved.Split('*')[1];
                        RunOnUiThread(ShowError);
                        break;
                    default:
                        ErrorText = "Exception GS107: " + System.Environment.NewLine + "Unexpected error while storing data";
                        RunOnUiThread(ShowError);
                        break;
                }
            }
            ...
            {
                ErrorText = "Exception GS108: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void BtnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception GS109: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
