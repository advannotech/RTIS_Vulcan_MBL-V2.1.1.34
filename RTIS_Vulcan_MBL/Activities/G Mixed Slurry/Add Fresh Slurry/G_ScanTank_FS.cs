...
{
    [Activity(Label = "G_ScanTank_FS")]
    public class G_ScanTank_FS : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        EditText txtTank;
        ...
        public void checkTank()
        {
            try
            {
                string tankChecked = Client.checkSlurryTankValid(GlobalVar.MSTankType + "|" + GlobalVar.MSTankCode + "|" + GlobalVar.MSItemCode);
                try
                {
                ...
                if (tankChecked != string.Empty)
                {
                    ...
                    {
                        case "1":
                            GlobalVar.MSAllSlurries = tankChecked.Remove(0, 2);
