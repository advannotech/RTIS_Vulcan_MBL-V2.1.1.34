...
{
    [Activity(Label = "G_Enter_New_Lot")]
    public class G_Enter_New_Lot : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        EditText txtLot;
        Button btnBack;
        ...
        private void TxtLot_KeyPress(object sender, View.KeyEventArgs e)
        {
            ...
            {
                ErrorText = "Exception G202: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void BtnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception G203: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
