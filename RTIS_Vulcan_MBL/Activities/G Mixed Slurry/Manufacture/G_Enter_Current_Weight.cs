...
{
    [Activity(Label = "G_Enter_Current_Weight")]
    public class G_Enter_Current_Weight : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        ...
        public void layoutStichUp()
        {
            try
            {
                ...
                lblHeader2.Text = "Enter Current Tank Weight";
        ...
        private void BtnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception G105: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        {
            StartActivity(typeof(G_Enter_Current_Weight));
            Finish();
        }
