...
{
    [Activity(Label = "F_Enter_Wet_Weight")]
    public class F_Enter_Wet_Weight : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        ...
        private void TxtWeight2_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keycode.Enter && e.Event.Action == KeyEventActions.Down)
                {
                    if (txtWeight2.Text.All(char.IsDigit))
                    {
                        ...
                        Confirm.SetMessage("Trolley Code: " + GlobalVar.FSTrolleyCode + System.Environment.NewLine + "Item: " + GlobalVar.FSItemDesc + System.Environment.NewLine + "Lot: " + GlobalVar.FSLotNum + System.Environment.NewLine + "Wet Weight: " + Convert.ToString(qty));
            ...
            {
                ErrorText = "Exception F203: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void BtnNext_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception F204: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        public void manufSlurry()
        {
            try
            {
                ...
                {
                    inserted = Client.AddNewFreshSlurry(GlobalVar.FSTrolleyCode + "|" + GlobalVar.FSItemCode + "|" + GlobalVar.FSLotNum + "|" + qty + "|" + GlobalVar.UserName + "|" + GlobalVar.FSRCode + "|" + GlobalVar.FSRLot + "|" + GlobalVar.FSRQty);
                }
                else
                {
                    inserted = Client.AddNewFreshSlurryNoRaws(GlobalVar.FSTrolleyCode + "|" + GlobalVar.FSItemCode + "|" + GlobalVar.FSLotNum + "|" + qty + "|" + GlobalVar.UserName);
                }
                ...
                switch (inserted.Split('*')[0])
                {
                    case "1":
                        ...
                        break;
                    case "0":
                        ErrorText = "Exception F205: " + System.Environment.NewLine + inserted.Split('*')[1];
                        RunOnUiThread(ShowError);
                        break;
                    case "-1":
                        ErrorText = "Exception F206: " + System.Environment.NewLine + inserted.Split('*')[1];
                        RunOnUiThread(ShowError);
                        break;
                    default:
            ...
            {
                ErrorText = "Exception F208: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        private void BtnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception F209: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        {
            StartActivity(typeof(F_Enter_Wet_Weight));
            Finish();
        }
