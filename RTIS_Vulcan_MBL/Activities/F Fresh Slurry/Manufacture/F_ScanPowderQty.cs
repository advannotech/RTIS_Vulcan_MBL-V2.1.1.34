...
{
    [Activity(Label = "F_ScanPowderQty")]
    public class F_ScanPowderQty : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        EditText txtBCD;
        ...
        private void TxtBCD_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keycode.Enter && e.Event.Action == KeyEventActions.Down)
                {
                    ...
                    Confirm.SetMessage(GlobalVar.FSRDesc + System.Environment.NewLine + "Lot: " + GlobalVar.FSRLot + System.Environment.NewLine + "Dry Weight: " + Convert.ToString(dQty));
                    Confirm.SetButton("YES", (s, ev) =>
                    {
                        GlobalVar.FSRQty = Convert.ToString(dQty);
