...
{
    [Activity(Label = "H_Scan_Prep_Sheet_PP")]
    public class H_Scan_Prep_Sheet_PP : Activity, View.IOnTouchListener
    {
        ...
        public void layoutStichUp()
        {
            try
            {
                ...
                lblHeader2.Text = "Scan Slurry Prep Check Sheet";
            ...
            {
                ErrorText = "Exception H301: " + System.Environment.NewLine + ex.ToString();
        ...
        private void TxtBCD_KeyPress(object sender, View.KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keycode.Enter && e.Event.Action == KeyEventActions.Down)
                {
                    ...
                    {
                        GlobalVar.PPtFSSlurryCode = txtBCD.Text;
                        StartActivity(typeof(H_ScanBCD_PP));
                        Finish();
                    }
                    else
                    {
                        ErrorText = "Exception H302: " + System.Environment.NewLine + "Please scan the check sheet!";
                        RunOnUiThread(ShowError);
                    }
                }
                else
            ...
            {
                ErrorText = "Exception H303: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
        ...
        private void BtnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorText = "Exception H304: " + System.Environment.NewLine + ex.ToString();
                RunOnUiThread(ShowError);
            }
        }
