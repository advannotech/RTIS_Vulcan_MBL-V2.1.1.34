...
{
    [Activity(Label = "H_Select_Whse_ToProd")]
    public class H_Select_Whse_ToProd : Activity, View.IOnTouchListener
    {
        TextView lblHeader1;
        TextView lblHeader2;
        ...
        public void layoutStichUp()
        {
            try
            {
                ...
                lblHeader1.Text = "Transfer to Production";
        ...
        public void GetWHTMSDetails()
        {
            try
            {
                string Whses = Client.getToProdWarehouses();
        ...
        private void SpnWhses_ItemSelected(object sender, AdapterView.ItemSelectedEventArgs e)
        {
            try
            {
                ...
                GlobalVar.ToProdWarehouseTo = GlobalVar.TransferWarehouses[e.Position].Code;
            }
            catch (Exception ex)
            {
